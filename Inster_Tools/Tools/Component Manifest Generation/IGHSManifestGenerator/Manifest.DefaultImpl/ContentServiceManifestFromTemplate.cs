...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class ContentServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            ContentServiceXmlGeneration xmlGen = new ContentServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
