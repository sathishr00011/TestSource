...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class CustomerServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            CustomerServiceXmlGeneration xmlGen = new CustomerServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
