...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class OrderCheckoutManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            OrderCheckoutXmlGeneration xmlGen = new OrderCheckoutXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
