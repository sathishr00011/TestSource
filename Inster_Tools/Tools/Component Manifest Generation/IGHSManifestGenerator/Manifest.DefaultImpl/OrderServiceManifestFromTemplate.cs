...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class OrderServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            OrderServiceXmlGeneration xmlGen = new OrderServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
