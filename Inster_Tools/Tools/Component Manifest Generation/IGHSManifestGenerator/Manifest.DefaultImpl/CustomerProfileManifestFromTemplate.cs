...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class CustomerProfileManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            CustomerProfileXmlGeneration xmlGen = new CustomerProfileXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
