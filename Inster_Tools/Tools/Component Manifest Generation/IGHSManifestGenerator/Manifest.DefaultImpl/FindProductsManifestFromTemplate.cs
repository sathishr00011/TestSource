...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class FindProductsManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            FindProductsXmlGeneration xmlGen = new FindProductsXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
