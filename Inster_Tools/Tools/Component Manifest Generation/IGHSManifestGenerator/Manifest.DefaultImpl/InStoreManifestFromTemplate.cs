...
{
    /// <summary>
    /// Generates the manifest from template for InStore
    /// </summary>
    public class InStoreManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            InStoreXmlGeneration xmlGen = new InStoreXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
