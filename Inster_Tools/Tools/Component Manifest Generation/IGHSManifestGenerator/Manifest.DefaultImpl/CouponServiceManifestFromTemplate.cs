...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class CouponServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            CouponServiceXmlGeneration xmlGen = new CouponServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
