...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class ProductIntegrationManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            ProductIntegrationXmlGeneration xmlGen = new ProductIntegrationXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
