...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class ReportingWebSiteManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            ReportingWebSiteXmlGeneration xmlGen = new ReportingWebSiteXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
