...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class StoreHouseServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            StoreHouseServiceXmlGeneration xmlGen = new StoreHouseServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
