...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class NotificationServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            NotificationServiceXmlGeneration xmlGen = new NotificationServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
