...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class AuthenticationServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            AuthenticationServiceXmlGeneration xmlGen = new AuthenticationServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
