...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class HomeManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            HomeXmlGeneration xmlGen = new HomeXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
