...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class MobileDispatcherManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            MobileDispatcherXmlGeneration xmlGen = new MobileDispatcherXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
