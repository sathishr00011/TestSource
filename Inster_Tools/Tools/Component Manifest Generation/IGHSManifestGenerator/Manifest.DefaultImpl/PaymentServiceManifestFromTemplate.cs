...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class PaymentServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            PaymentServiceXmlGeneration xmlGen = new PaymentServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
