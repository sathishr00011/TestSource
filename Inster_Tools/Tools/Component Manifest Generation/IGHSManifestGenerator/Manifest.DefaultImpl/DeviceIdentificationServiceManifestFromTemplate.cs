...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class DeviceIdentificationServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            DeviceIdentificationServiceXmlGeneration xmlGen = new DeviceIdentificationServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
