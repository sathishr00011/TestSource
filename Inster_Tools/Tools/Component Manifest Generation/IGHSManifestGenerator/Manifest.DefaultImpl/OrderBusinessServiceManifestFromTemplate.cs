...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class OrderBusinessServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            OrderBusinessServiceXmlGeneration xmlGen = new OrderBusinessServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
