...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class LoyaltyServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            LoyaltyServiceXmlGeneration xmlGen = new LoyaltyServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
