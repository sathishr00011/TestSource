...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class EntprseAuthenticationServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            EntprseAuthenticationServiceXmlGeneration xmlGen = new EntprseAuthenticationServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
