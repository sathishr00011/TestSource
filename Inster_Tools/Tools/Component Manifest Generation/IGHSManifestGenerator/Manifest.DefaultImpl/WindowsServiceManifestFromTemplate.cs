...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class WindowsServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            WindowsServiceXmlGeneration xmlGen = new WindowsServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
