...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class ConsoleAppManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            ConsoleAppXmlGeneration xmlGen = new ConsoleAppXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
