...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class MyAccountManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            MyAccountXmlGeneration xmlGen = new MyAccountXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
