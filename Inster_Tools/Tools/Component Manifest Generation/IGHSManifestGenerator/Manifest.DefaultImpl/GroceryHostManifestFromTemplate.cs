...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class GroceryHostManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            GroceryHostXmlGeneration xmlGen = new GroceryHostXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
