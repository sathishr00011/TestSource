...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class DeliveryManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            DeliveryXmlGeneration xmlGen = new DeliveryXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
