...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class AppStoreManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            AppStoreXmlGeneration xmlGen = new AppStoreXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
