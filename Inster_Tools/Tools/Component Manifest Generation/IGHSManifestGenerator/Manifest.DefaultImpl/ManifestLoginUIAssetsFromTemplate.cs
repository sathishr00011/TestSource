...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class LoginUIAssetsManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            LoginUIAssetsXmlGeneration xmlGen = new LoginUIAssetsXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
