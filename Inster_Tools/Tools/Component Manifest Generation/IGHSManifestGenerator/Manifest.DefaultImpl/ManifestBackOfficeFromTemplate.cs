...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class BackOfficeManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            BackOfficeXmlGeneration xmlGen = new BackOfficeXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
