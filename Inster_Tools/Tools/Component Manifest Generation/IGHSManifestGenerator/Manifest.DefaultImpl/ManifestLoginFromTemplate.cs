...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class LoginManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            LoginXmlGeneration xmlGen = new LoginXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
