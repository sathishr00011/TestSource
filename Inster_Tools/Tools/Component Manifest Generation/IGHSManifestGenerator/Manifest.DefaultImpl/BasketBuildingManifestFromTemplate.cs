...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class BasketBuildingManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            BasketBuildingXmlGeneration xmlGen = new BasketBuildingXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
