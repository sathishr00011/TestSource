...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class ShoppingCartServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            ShoppingCartServiceXmlGeneration xmlGen = new ShoppingCartServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
