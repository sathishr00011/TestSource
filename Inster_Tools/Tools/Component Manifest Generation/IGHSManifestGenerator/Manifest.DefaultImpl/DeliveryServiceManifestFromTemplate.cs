...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class DeliveryServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            DeliveryServiceXmlGeneration xmlGen = new DeliveryServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
