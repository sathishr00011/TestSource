...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class ReportingManagementServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            ReportingManagementServiceXmlGeneration xmlGen = new ReportingManagementServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
