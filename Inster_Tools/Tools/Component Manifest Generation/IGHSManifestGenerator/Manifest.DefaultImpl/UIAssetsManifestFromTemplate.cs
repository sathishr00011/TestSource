...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class UIAssetsManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            UIAssetsXmlGeneration xmlGen = new UIAssetsXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
