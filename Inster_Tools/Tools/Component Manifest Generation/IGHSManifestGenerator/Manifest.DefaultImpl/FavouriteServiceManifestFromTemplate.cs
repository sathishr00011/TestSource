...
namespace Manifest.DefaultImpl
{
    ...
    /// </summary>
    public class FavouriteServiceManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            FavouriteServiceXmlGeneration xmlGen = new FavouriteServiceXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
