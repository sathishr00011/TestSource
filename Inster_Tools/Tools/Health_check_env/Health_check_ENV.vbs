...
InputFile="d:\health_check_script\Servers_DEV.txt"

'Declare 'outputMessage' variable to capture HTML message
outputMessage = ""
outputMessage1 = ""
Outputfile="d:\health_check_script\Storage_HealthCheck.html"
...
outputMessage =  outputMessage &   "<tr style=background:Blue;><th colspan=5 align=center  style=color:White>DEV/DBT |Grocery Online International|  LOW DISK SPACE REPORTED On " & Date() & " at " & Time() &"</th></tr><tr class=status_passed><th colspan=5 align=right>Disk Space Alerts &lt; 10% (Marked as Red)</th></tr><tr><th width=150>Server</th><th width=150>Drive</th><th width=150>Disk Size (GB)</th><th width=150>FreeSpace (GB)</th><th width=150>%</th></tr>"
...
outputMessage =  outputMessage &   "<tr style=background:#35586C;><th colspan=5 align=center  style=color:White>DEV :CPU useage & Memory Useage " & Date() & " at " & Time() &"</th></tr>"
...
objMessage.Subject = "Disk Space and CPU Utilization" 
objMessage.From = "HSC_Devops_IGHS@in.tesco.com" 
objMessage.To = "HSC_Devops_IGHS@in.tesco.com" 
