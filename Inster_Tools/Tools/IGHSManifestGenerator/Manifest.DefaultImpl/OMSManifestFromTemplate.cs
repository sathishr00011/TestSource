...
{
    /// <summary>
    /// Generates the manifest from template for OMS
    /// </summary>
    public class OMSManifestFromTemplate : IManifest
    {
        /// <summary>
        ...
        {
            OMSXmlGeneration xmlGen = new OMSXmlGeneration(templateCategory, regions, version, outputManifestPath, tag, searchDirectoryPath);
        }
    }
}
