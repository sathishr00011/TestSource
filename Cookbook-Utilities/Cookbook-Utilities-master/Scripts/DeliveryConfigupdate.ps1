...
#$cookbooklocation="G:\Chef\IGHS\chef-repo\cookbooks\Delivery_Service"
...
$nodelist=$doc.SelectNodes('/Application/Environment/Services/Service[@name="AppStore.Delivery.Service"]/Web.Config/LoggingConfiguration/Listeners')
##
...
## Application prameter file ##
$nodelist1=$doc.SelectNodes('/Application/Environment/Services/Service[@name="AppStore.Delivery.Service"]/Web.Config/LoggingConfiguration/CategorySources')
##
...
$nodename1=$_.Name
    ...
    if ($nodename1 -eq "TescoDeliveryApp")
    {
    $value=$_.value
...
## Application prameter file ##
$nodelist2=$doc.SelectNodes('/Application/Environment/Services/Service[@name="AppStore.Delivery.Service"]/Web.Config/appSettings')
##
...
$doc.Application.Environment.Services.Service | % { 
        if ($_.name -eq "AppStore.Delivery.Service")
        { 
         $_.DBConnection | % {
         $namedb=$_.name 
         $conn_password= $_.Account.Delivery.Password.value
         $conn_userid =  $_.Account.Delivery.UserId.value
