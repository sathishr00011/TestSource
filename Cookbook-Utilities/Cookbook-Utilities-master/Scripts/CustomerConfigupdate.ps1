...
$nodelist=$doc.SelectNodes('/Application/Environment/Services/Service[@name="AppStore.Customer.Service"]/Web.Config/LoggingConfiguration/Listeners')
##
...
## Application prameter file ##
$nodelist1=$doc.SelectNodes('/Application/Environment/Services/Service[@name="AppStore.Customer.Service"]/Web.Config/LoggingConfiguration/CategorySources')
##
...
$nodename1=$_.Name
    ...
    if ($nodename1 -eq "TescoCustomerApp")
    {
    $value=$_.value
...
## Application prameter file ##
$nodelist2=$doc.SelectNodes('/Application/Environment/Services/Service[@name="AppStore.Customer.Service"]/Web.Config/appSettings')
##
...
$doc.Application.Environment.Services.Service | % { 
        ...
        { 
         $_.DBConnection | % {
         $namedb=$_.name 
         $conn_password= $_.Account.Customer.Password.value
         $conn_userid =  $_.Account.Customer.UserId.value
